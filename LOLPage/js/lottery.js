...
var Lottery = (function() {
	...
	var init = function() {
		itemCount = $item.size();	//Pre-caculate the count of items
		$content.append($content.html());		//Clone the contents
	};
...
$(document).keydown(function(e) {
	...
	Lottery.running() ? Lottery.stop() : Lottery.start();
});